...
public class MainViewEpaController implements Initializable{
    @FXML
    ...
    private void handleMakeNewAccount(ActionEvent event) throws IOException
    {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("../view/registerClientVip.fxml"));
        ...
        try
        {
            ...
            else
            {
                if(validateLogin(firstNameEntered, lastNameEntered, accountNumberEntered))
                {
                    ...
                    Pane root = loader.load(getClass().getResource("../view/viewAccountsVip.fxml").openStream());
