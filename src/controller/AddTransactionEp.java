...
public class AddTransactionEp implements Initializable{
    @FXML
    ...
    private ObservableList<String> transactionTypes = FXCollections.observableArrayList("transfer", "Deposit", "Withdrawal");
