...
public class RegisterClientEp implements Initializable {
    ...
    private void switchSceneToViewAccount() {
        ...
        try {
            ...
            Parent viewAccountScene = fxmlLoader.load((getClass().getResource("../view/viewAccountsEp.fxml").openStream()));
    ...
    private boolean insertNewClient() {
        ...
        String createClientStatement = "INSERT INTO clients values (" +
                "'" + clientFirstName + "', '" + clientLastName + "', '" + clientSocialSecurity + "', '" + ag + "', '" + tc + "' " + ")";
