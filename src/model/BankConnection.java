...
public final class BankConnection
{
    ...
    private void setUpClientTable()
    {
        ...
        String createClientTableQuery = "CREATE TABLE IF NOT EXISTS " + CLIENT_TABLE + " ( " + " first_name VARCHAR(15) NOT NULL, " + " last_name VARCHAR(15) NOT NULL, " + " agence VARCHAR(9) NOT NULL,"+ " type_client VARCHAR(9) NOT NULL,"+ " social VARCHAR(9) NOT NULL PRIMARY KEY )";
